...
const Achievements = (() => {
  ...
  const DEFINITIONS = [
    ...
    { id: 'ach_vit_20',         icon: '🛡️',  title: 'Iron Heart',        desc: 'Reach VIT stat 20.',                          check: (p) => (p.stats.VIT || 0) >= 20 },
    { id: 'ach_all_stats_10',   icon: '✨',  title: 'Well-Rounded',      desc: 'Reach 10 in STR, AGI, and VIT.',              check: (p) => (p.stats.STR || 0) >= 10 && (p.stats.AGI || 0) >= 10 && (p.stats.VIT || 0) >= 10 },
